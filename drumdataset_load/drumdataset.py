    ...
    def __init__(self, labels, train=True, dtype='tmel'):
        ...
        if self.train == True:
            ...
            for item in label_list:
                path_t = "./data_test/Dataset_train/time/"+self.labels[item]+'/'
                path_mel = "./data_test/Dataset_train/mel/"+self.labels[item]+'/'
            ...
            for item in label_list:
                path_t = "./data_test/Dataset_valid/time/"+self.labels[item]+'/'
                path_mel = "./data_test/Dataset_valid/mel/"+self.labels[item]+'/'
                for n,data in enumerate(os.listdir(path_t)):   
                    img = self.data_config(path_t,path_mel,n,data)
